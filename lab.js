...
const myFirstVehicle = new Vehicle(4, 'red', 16660)
...
const myFirstMotorcycle = new Motorcycle(2, 'black', 4000, 'yamaha', true)
...
class Boat extends Vehicle{
  ...
  checkSeaWorthiness(){
    if(this.isSeaWorthy){
      console.log(`${color} ${type} ${name} is seaworthy!`)
    } else {
...
const myFirstBoat = new Boat(3, 'silver', 400, 'the honey hole', 'fishing boat', false)
